// https://www.scaler.com/academy/mentee-dashboard/class/236100/assignment/problems/4531?navref=cl_tt_nv
...
int Solution::solve(int A) {
    int totalhelp = 0;
    while (A > 0) {
        totalhelp += A & 1;  // Check if the least significant bit is 1
        A >>= 1;         
    }
    return totalhelp;
}
